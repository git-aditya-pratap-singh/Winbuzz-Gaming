...
const NotFound = () => {
    return (
        <section className="h-[100vh] w-full flex flex-col justify-center items-center">
            ...
            <span className="text-[3.5rem] text-[var(--secondary)] font-bold">Oops !</span>
            ...
            <NavLink to="/">
                <button className="mt-5 ring-1 py-2 px-3 rounded shadow-sm text-white outline-none" style={{ background: "var(--theme-color)" }}>Go back to the homepage</button>
            </NavLink>
        </section>
    )
}
