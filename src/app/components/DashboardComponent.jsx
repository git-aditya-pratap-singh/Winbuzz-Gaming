...
const DashboardComponent = () =>{
    ...
    const data = ['CRICKET','FOOTBALL','TENNIS','POLITICS','CASINO','INTCASINO','SPORTS BOOK',
        'HORSE RACING','GREY HOUND','RACING','BINARY','KABADDI','BASKETBALL','BASEBALL','TABLE TENNIS','VOLLEYBALL','ICE HOCKEY','RUGBY',
        'MIXED MARTIAL ARTS','DARTS','FUTSAL']
    ...
    return(
        ...
        <section className="conatiner">
            <div className="subContainerA">
                ...
                <div className={`subChildContainerAB ${toggle ? 'right-0' : 'left-[800px]'}`}>
                    <button>
                    <svg _ngcontent-gim-c82="" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25px" height="25px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve"><g _ngcontent-gim-c82=""><circle _ngcontent-gim-c82="" fill="#ffffff" cx="32" cy="14" r="3"></circle><path _ngcontent-gim-c82="" fill="#ffffff" d="M4,25h56c1.794,0,3.368-1.194,3.852-2.922c0.484-1.728-0.242-3.566-1.775-4.497l-28-17
                ...
                <div className="bg-[transparent] border border-gray-200 rounded">
            ...
            <div className="subContainerC">
               <div className="subChildContainerCA"></div>
