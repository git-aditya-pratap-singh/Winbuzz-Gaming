...
const MyBets = ()=>{
    const tableHeader = ['Event Name','Nation','Bet Type','User Rate','Amount','Profit/loss','Place Date','Match Date'];
    return(
        <section className="betsConatiner">
            {/* <h1>By Bets</h1> */}
            <div className="betsHeader">
                <h1 className="betsHeading">By Bets</h1>
                <div className="betsHeader-section-item">
                    <div className="itemSection">
                        <span><input type="radio" name="match"/>&nbsp;Matched</span>
                        <span><input type="radio" name="match"/>&nbsp;Unmatched</span>
                    </div>
